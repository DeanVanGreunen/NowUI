...
//! a library and either call `nowui_runtime::run_path(path, entry, my_state)`
...
//! and call `nowui_runtime::run(entry, my_state)` instead (see
...
fn main() -> ExitCode {
    ...
    nowui_runtime::run_path(&path, &entry, nowui_core::NoState)
}
